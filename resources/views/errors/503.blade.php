...
<head>
    ...
    <title> Currently down bro.. </title>
    <!-- Tab Icon -->
...
<body>
    ...
    <section id="contentLoaded" style="display: none;">
        ...
        <footer class="bg-dark text-center fixed-bottom" id="foot">
            <p style="font-size: 10px; margin-bottom: -3px;"> made with 🤌 by <a
                    href="https://www.instagram.com/resaka.xmp/" target="_blank">resaka</a> </p>
            <p style="font-size: 12px; margin-bottom: -2px;">&copy; 2024 SURVEYS - STEPME'S PLACE</p>
        </footer>
