            ...
            <div class="col-md-8">
                ...
                <form id="surveyForm">
                            ...
                            <div class="row d-flex mt-2">
                                <div class="col-md-6">
                                    ...
                                    <select name="pekerjaan" id="pekerjaan" class="form-control">
                                        ...
                                        <option value="Pengusaha/Entreprenuer" id="pekerjaanDefault">Pengusaha/Entreprenuer
                                        </option>
                                        <option value="Wiraswasta" id="pekerjaanDefault">Wiraswasta</option>
                                        <option value="PNS (Pegawai Negeri Sipil)" id="pekerjaanDefault">PNS (Pegawai Negeri
                                            Sipil)</option>
                                        ...
                                        <option value="Profesional Kesehatan" id="pekerjaanDefault">Profesional Kesehatan
                                        </option>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <section id="bidangIndustriSpesifikSection" class="mt-2" style="display: none;">
                    ...
                    <div class="card rounded shadow border-0 bg-light mt-3">
                        <div class="card-body">
                            <label for="menggunakanEmail">Seberapa sering Anda menggunakan email untuk keperluan pribadi
                            ...
                            <select name="menggunakanEmail" id="menggunakanEmail" class="form-control">
                                ...
                                <option value="Jarang Sekali atau Tidak Pernah">Jarang Sekali atau Tidak Pernah</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="card rounded shadow border-0 bg-light mt-3">
                        <div class="card-body">
                            ...
                            <select name="mengalami" id="mengalami" class="form-control">
                                ...
                                <option value="Mungkin, Tetapi Saya Tidak Yakin">Mungkin, Tetapi Saya Tidak Yakin</option>
                    ...
                    <div class="card rounded shadow border-0 bg-light mt-3">
                        <div class="card-body">
                            ...
                            <select name="korban" id="korban" class="form-control">
                                ...
                                <option value="Tidak, Saya Belum Pernah Menjadi Korban">Tidak, Saya Belum Pernah Menjadi
                                    Korban
                                </option>
                                <option value="Tidak Yakin">Tidak Yakin</option>
                                <option value="Mungkin, Tetapi Saya Tidak Yakin">Mungkin, Tetapi Saya Tidak Yakin</option>
                    ...
                    <div class="card rounded shadow border-0 bg-light mt-3">
                        <div class="card-body">
                            <label for="penggunaExtension">Apakah Anda pernah menggunakan atau menginstall aplikasi Chrome
                        ...
                        <div class="card-body">
                            <label>Apa yang menurut Anda menjadi fitur utama yang harus dimiliki oleh
                                aplikasi deteksi email penipuan agar dapat membantu Anda secara efektif? <span
                                    style="color: red">*</span> </label> <span> (**Plih bisa lebih dari satu**) </span><br>
                    ...
                    <div class="card rounded shadow border-0 bg-light mt-3">
                        <div class="card-body">
                            ...
                            <div class="m-3">
                                ...
                                <input type="checkbox" id="cb13" class="fiturCheckbox1 mt-3" value="Yahoo Mail">
                                <span style="cursor: pointer;" id="tcb13">Yahoo Mail</span> <br>

                                <input type="checkbox" id="cb14" class="fiturCheckbox1 mt-3" value="Apple Mail">
                    ...
                    <div class="mt-4" align="center">
                        <button class="btn btn-rounded btn-success" id="btnSubmit" style="width: 50%" type="submit"> <i
                                class="spinner-border spinner-border-sm" id="submitSpinner" style="display: none;"></i>
                            Submit </button>
                        <button class="btn btn-rounded btn-secondary mt-2" style="width: 50%" type="reset"> Clear
                        </button>
                    </div>
